...
const TermsAndConditions = () => {
  return (
    <div className="terms-and-conditions-container max-w-2xl mx-auto px-4 py-8">
      ...
      <p className="mb-4">These terms and conditions ("Terms", "Agreement") are an agreement between Healthrepublicmedia.com.ng ("us", "we", or "our") and you ("User", "you", or "your"). This Agreement sets forth the general terms and conditions of your use of the Healthrepublicmedia.com.ng website and any of its products or services (collectively, "Website" or "Services").</p>
      ...
      <p className="mb-4">The Website and its original content, features, and functionality are owned by Healthrepublicmedia.com.ng and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>

...
export default function CallToAction() {
  return (
    <div className='flex flex-col sm:flex-row p-3 border border-teal-700 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center bg-green-500'>
        <div className="flex-1 justify-center flex flex-col ">
            ...
            <Button gradientMonochrome="cyan" className='rounded-tl-xl rounded-bl-none'>
